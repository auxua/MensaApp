...
namespace MensaAppWin
{
    public class Localization
    {
        ...
        public static string Localize(string key)
        {
            ...
            ResourceCandidate res1 = ResourceManager.Current.MainResourceMap.GetValue("Resources/" + key, ResourceContext.GetForViewIndependentUse());

            //string result = temp.GetString(key, cult);

            string result = res1.ValueAsString;
